...
const EditTaskForm: React.FC<EditTaskFormProps> = ({ task }) => {
    ...
    const [isCompleted, setIsComplited] = useState(task.isCompleted);
    ...
    const SubmitButton = () => {
        ...
        return (
            <button 
                type="submit" 
                disabled={pending}
                className="mt-8 py-2 w-full rounded-md
                text-white bg-gray-800 hover:bg-gray-700 text-sm font-semibold shadow-sm
            ...
            <form action={formAction}>
                ...
                <div className="mt-6 flex items-center">
                    <input 
                        ...
                        checked={isCompleted}
                        onChange={(e) => setIsComplited(e.target.checked)}
                        />
